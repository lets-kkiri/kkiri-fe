...
export const setTokenHeader = (config: any) => {
  config.headers.Authorization =
    'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIyNzg1NTI5NzA1IiwiaXNzIjoiS0tJUkkiLCJleHAiOjE2OTYzMDg5OTcsImlhdCI6MTY4NDIxMjk5N30.D4qnERr8nWBC_nZGoF5Qe5MBIX_JruXdAq1_MWYGwnqm8cqNqnSGGQn28N3tvi2nq5GeNTa5C3iMJ9aLXp-1FQ';
  // console.log(config);
  return config;
};
